...
COMBO_DIR = BASE / "Codes" / "Testing" / "3-channel (Mel, CQT, Gamma) + ResNet50"
CKPT_PATH = COMBO_DIR / "Outputs" / "resnet50_mcg_best.pt"
...
def format_latex(per_class, summary):
    """Matches the Classification Report table in the paper."""
